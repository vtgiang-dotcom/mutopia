...
public class Stats
{
    ...
    /// <summary>
    /// Gets the Ruud currency attribute definition.
    /// </summary>
    public static AttributeDefinition Ruud { get; } = new(new Guid("4A7B2C91-0D1E-4F3A-8B5C-7D9E1F3A5B7C"), "Ruud Currency", "The Ruud points earned from events and quests.");
