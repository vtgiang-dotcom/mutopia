// <copyright file="NixiesLake.cs" company="MUnique">
...
/// <summary>
/// The initialization for the Nixies Lake map.
/// </summary>
internal class NixiesLake : BaseMapInitializer
{
    /// <summary>The Number of the Map.</summary>
    internal const byte Number = 113;

    /// <summary>The Name of the Map.</summary>
    internal const string Name = "Nixies Lake";

    public NixiesLake(IContext context, GameConfiguration gameConfiguration)
