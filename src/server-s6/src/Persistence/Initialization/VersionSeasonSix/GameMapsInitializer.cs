...
public class GameMapsInitializer : GameMapsInitializerBase
{
    ...
    protected override IEnumerable<Type> MapInitializerTypes
    {
        get
        {
            ...
            yield return typeof(Deventer1);
            yield return typeof(Deventer2);
            yield return typeof(UrkMountain1);
            yield return typeof(UrkMountain2);
            yield return typeof(Nars);
            yield return typeof(Ferea);
            yield return typeof(NixiesLake);
            ...
            yield return typeof(KuberaMine1);
            yield return typeof(AtlansAbyss1);
