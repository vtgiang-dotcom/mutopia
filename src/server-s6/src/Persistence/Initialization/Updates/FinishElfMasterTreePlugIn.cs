...
public class FinishElfMasterTreePlugIn : UpdatePlugInBase
{
    ...
    protected override async ValueTask ApplyAsync(IContext context, GameConfiguration gameConfiguration)
    {
        ...
        if (infinityArrowEffect.PowerUpDefinitions.FirstOrDefault(pud => pud.TargetAttribute == Stats.AttackDamageIncrease) is PowerUpDefinition infinityArrowPowerUp && infinityArrowPowerUp.Boost != null)
        {
