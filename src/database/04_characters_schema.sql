...
-- --------------------------------------------------
-- Dynamic Tables for database_characters (LgdMu S16)
-- --------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `character_info` (
  ...
  `level_master` int(11) NOT NULL DEFAULT 0,
  `level_majestic` int(11) NOT NULL DEFAULT 0,
  ...
  `world` smallint(6) NOT NULL DEFAULT 0,
  `world_x` smallint(6) NOT NULL DEFAULT 125,
  `world_y` smallint(6) NOT NULL DEFAULT 125,
  `direction` tinyint(4) NOT NULL DEFAULT 0,
  `money` bigint(20) NOT NULL DEFAULT 0,
  `ruud_money` bigint(20) NOT NULL DEFAULT 0,
  `goblin_points` int(11) NOT NULL DEFAULT 0,
  `add_fruit_points` int(11) NOT NULL DEFAULT 0,
  `dec_fruit_points` int(11) NOT NULL DEFAULT 0,
  `expanded_inventory` tinyint(4) NOT NULL DEFAULT 0,
  `mute_time` int(11) NOT NULL DEFAULT 0,
  `admin_flags` int(11) NOT NULL DEFAULT 0,
  `pk_level` int(11) NOT NULL DEFAULT 3,
  `pk_count` int(11) NOT NULL DEFAULT 0,
  `pk_points` int(11) NOT NULL DEFAULT 0,
  `first_time` tinyint(4) NOT NULL DEFAULT 1,
  `santa_claus_gift` int(11) NOT NULL DEFAULT 0,
  `personal_store_name` varchar(50) NOT NULL DEFAULT '',
  `kick_time` int(11) NOT NULL DEFAULT 0,
  `post_count` int(11) NOT NULL DEFAULT 0,
  `post_day` int(11) NOT NULL DEFAULT 0,
  `post_month` int(11) NOT NULL DEFAULT 0,
  `create_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `hunting_log_visible` tinyint(4) NOT NULL DEFAULT 1,
  `online` tinyint(4) NOT NULL DEFAULT 0,
  `server_code` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `item_data` (
  ...
  `380` tinyint(4) NOT NULL DEFAULT 0,
  `harmony` tinyint(4) NOT NULL DEFAULT 0,
  `socket_1` smallint(6) NOT NULL DEFAULT 0,
  `socket_2` smallint(6) NOT NULL DEFAULT 0,
  `socket_3` smallint(6) NOT NULL DEFAULT 0,
  `socket_4` smallint(6) NOT NULL DEFAULT 0,
  `socket_5` smallint(6) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `account_data` (
  ...
  `vip_duration` bigint(20) NOT NULL DEFAULT 0,
  `expanded_warehouse` tinyint(4) NOT NULL DEFAULT 0,
  `expanded_warehouse_time` bigint(20) NOT NULL DEFAULT 0,
  `special_character` int(11) NOT NULL DEFAULT 0,
  `credits` int(11) NOT NULL DEFAULT 0,
  `web_credits` int(11) NOT NULL DEFAULT 0,
  `cash_shop_discount_wc` int(11) NOT NULL DEFAULT 0,
  `cash_shop_discount_gp` int(11) NOT NULL DEFAULT 0,
  `cash_shop_discount_date` datetime DEFAULT NULL,
  `current_character` int(11) NOT NULL DEFAULT 0,
  `current_type` int(11) NOT NULL DEFAULT 0,
  `current_server` int(11) NOT NULL DEFAULT 0,
  `current_ip` varchar(50) NOT NULL DEFAULT '',
  `current_mac` varchar(50) NOT NULL DEFAULT '',
  `current_diskserial` varchar(50) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `character_skill` (
  ...
  PRIMARY KEY (`char_id`, `type`, `skill`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `character_quest_evo` (
  `char_id` int(11) NOT NULL,
  `state` int(11) NOT NULL DEFAULT 0,
  `monster_kill_1` int(11) NOT NULL DEFAULT 0,
  `monster_kill_2` int(11) NOT NULL DEFAULT 0,
  `monster_kill_3` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`char_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `character_gameoption` (
  `char_id` int(11) NOT NULL,
  `game_option` int(11) NOT NULL DEFAULT 0,
  `chat_window` int(11) NOT NULL DEFAULT 0,
  `q_key` int(11) NOT NULL DEFAULT 0,
  `w_key` int(11) NOT NULL DEFAULT 0,
  `e_key` int(11) NOT NULL DEFAULT 0,
  `r_key` int(11) NOT NULL DEFAULT 0,
  `qwer_level` int(11) NOT NULL DEFAULT 0,
  `change_skin` tinyint(4) NOT NULL DEFAULT 0,
  PRIMARY KEY (`char_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `guild` (
  ...
  `hostil` int(11) NOT NULL DEFAULT 0,
